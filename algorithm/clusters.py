...
def displayClusterData(cluster_dfs, iataCode):
    if os.path.exists(f'algorithm/data/flightData/maps/clusters/{iataCode}') and os.path.isdir(f'algorithm/data/flightData/maps/clusters/{iataCode}'):
        shutil.rmtree(f'algorithm/data/lightData/maps/clusters/{iataCode}') #remove the directory and its contents
    for cluster in cluster_dfs:
        ...
        os.makedirs(f'algorithm/data/flightData/maps/clusters/{iataCode}', exist_ok=True) #create a new directory
        map.save(f'algorithm/data/flightData/maps/clusters/{iataCode}/cluster_{cluster_num}_map.html') #save the map
...
def createClusters(iataCode):
    data_path = f"algorithm/data/flightData/data/flight_log_{iataCode}.csv" 
